...
$_proposalDistRSD=0.00004																# Standard deviation of the proposal distribution of growth rates 'r'
...
& $_nameOfProgram $_pathToDataFile $_outputFileName $_noSkipColumns $_outliersPresent $_burnin $_subSampling $_noSets $_setSize $_proposalDistCScale $_proposalDistRSD $_initialRC $_print_LogLikelihoodTS $_print_ESS $_print_OutputToScreen $_time_Hours $_randomNumberSeed